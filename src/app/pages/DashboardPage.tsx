    ...
    <div className="space-y-6">
      ...
      <div className="p-6 bg-white border-l-4 border-gray-900 rounded-lg shadow-sm">
        <h4 className="text-xs font-bold text-gray-900 mb-3 uppercase tracking-wide">
          📌 HALAMAN 2 — SMART DASHBOARD (DATA REAL)
        </h4>
        <div className="space-y-3 text-xs text-gray-700 leading-relaxed">
          <div>
            <span className="font-semibold">FITUR UTAMA:</span>
            <ul className="ml-4 mt-1 space-y-1 list-disc">
              <li><strong>Summary Cards:</strong> Total Pemasukan, Pengeluaran, Net Cash Flow dari transaksi real</li>
              <li><strong>Trend Analysis:</strong> Line chart & Bar chart dari data bulanan transactions</li>
              <li><strong>Kategori Breakdown:</strong> Pie chart distribusi pengeluaran per kategori</li>
              <li><strong>Recent Transactions:</strong> 10 transaksi terbaru dari database</li>
              <li><strong>Smart Insights:</strong> Generated dari data real (warning, alert, success, recommendation)</li>
            </ul>
          </div>
          <div>
            <span className="font-semibold">DATA SOURCE:</span> Tabel transaksi MySQL via GET /api/transaksi
          </div>
        </div>
      </div>

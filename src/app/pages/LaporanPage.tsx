    ...
    <div className="space-y-6">
      ...
      <div className="p-6 bg-white border-l-4 border-gray-900 rounded-lg shadow-sm">
        <h4 className="text-xs font-bold text-gray-900 mb-3 uppercase tracking-wide">
          📌 HALAMAN 4 — LAPORAN KEUANGAN (FITUR UTAMA 2) - DATA REAL
        </h4>
        <div className="space-y-3 text-xs text-gray-700 leading-relaxed">
          ...
          <div>
            <span className="font-semibold">DATA SOURCE:</span> Real data dari tabel transaksi MySQL via GET /api/transaksi
          </div>
        </div>
      </div>
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200">
      <div className="p-6 border-b border-gray-200">
        ...
        <p className="text-sm text-gray-500 mt-1">Fitur dalam pengembangan</p>
      </div>
      <div className="p-12 text-center text-gray-500">
        <FileText className="w-12 h-12 mx-auto mb-4 text-gray-300" />
        <p>Fitur Buku Besar memerlukan struktur akun yang terpisah.</p>
        <p className="text-sm mt-2">Akan segera ditambahkan di sprint berikutnya.</p>
      </div>
    </div>
  );
}
...
function NeracaContent() {
  return (
    <div className="bg-white rounded-lg border border-gray-200">
      ...
      <div className="p-12 text-center text-gray-500">
        <FileText className="w-12 h-12 mx-auto mb-4 text-gray-300" />
        <p>Fitur Neraca memerlukan data aset dan liabilitas terpisah.</p>
        <p className="text-sm mt-2">Akan segera ditambahkan di sprint berikutnya.</p>
      </div>
    </div>
  );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200">
        ...
        <div className="p-6">
          {Object.keys(expenseByCategory).filter(k => 
            filteredTransactions.some(t => t.tipe === "pemasukan" && (t.kategori || "Lainnya") === k)
          ).length > 0 ? (
